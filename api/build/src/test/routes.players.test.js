...
describe("routes: players", function () {
    beforeEach(function () {
        return knex.migrate
            .rollback()
            .then(function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, knex("users").insert(testUser).returning("*").id];
                    case 1:
                        UID = _a.sent();
                        console.log(UID.id);
                        return [2 /*return*/, UID];
    ...
    describe("GET " + BASE_URL + "/:uid", function () {
        it("should return all seeded players", function (done) {
            chai
                .request(server)
                .get("" + BASE_URL)
