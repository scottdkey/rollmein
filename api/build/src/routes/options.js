...
var BASE_URL = config_1.default.BASE_URL + "/options";
router.get(BASE_URL + "/:uid/:id", function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var options;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, options_1.default.getOptions(ctx.params.uid, ctx.params.id)];
            case 1:
                options = _a.sent();
                if (options.length) {
                    ctx.body = options;
...
router.put(BASE_URL + "/:id", function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, options_1.default.updateUserOptions(ctx.params.id, ctx.request.body)];
            case 1:
                options = _a.sent();
                if (options) {
                    ctx.status = 200;
            ...
            case 2:
                err_1 = _a.sent();
                ctx.status = 400;
                ctx.body = err_1.message || "Sorry, a generic error has occurred";
                return [3 /*break*/, 3];
