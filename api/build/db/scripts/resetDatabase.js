...
var resetDatabase = function (environment, dbName) { return __awaiter(void 0, void 0, void 0, function () {
    var stdout, _i, _a, line;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                console.log("Resetting " + environment + " database");
                return [4 /*yield*/, sh("psql && DROP DATABASE IF EXISTS " + dbName + " && CREATE DATABASE " + dbName)];
            case 1:
