...
export class UserService {
  ...
  /**
   *
   * @param message a string to communicate intent of error
   * @param e error generated by a try{}catch{} block or new Error
   * @param context location error was generated, is defaulted to UserService but can be overwritten
   */
  logError(message: string, e: any, context = "UserService") {
    const error = createError({
      message,
      type: ErrorTypes.USER_ERROR,
      stacktrace: e.stacktrace,
