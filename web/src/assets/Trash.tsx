...
export const Trash = () => {
  return (
    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash" className="delete-icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
